	...
	: HttpFunctionBase<DictionaryFunction>(logger)
{
	...
	public async Task<IActionResult> FindRootAsync([HttpTrigger(AuthorizationLevel.Function, "get", Route = $"{ROUTE_PREFIX}/root/list")] HttpRequest request, FunctionContext context, int skip = RequestConstant.Defaults.Skip, int take = RequestConstant.Defaults.Take)
	{
	...
	public async Task<IActionResult> CountRootAsync([HttpTrigger(AuthorizationLevel.Function, "get", Route = $"{ROUTE_PREFIX}/root/count")] HttpRequest request, FunctionContext context)
	{
		return await ExecuteAsync(async () =>
		{
			var criteria = context.GetQueryParameter<DictionaryRootCriteriaDto>();
	...
	public async Task<IActionResult> LookupAsync([HttpTrigger(AuthorizationLevel.Function, "post", Route = $"{ROUTE_PREFIX}/lookup")] HttpRequest request, FunctionContext context, bool? isValid = null)
	{
		return await ExecuteAsync(async () =>
		{
	...
	public async Task<IActionResult> CreateRootAsync([HttpTrigger(AuthorizationLevel.Function, "post", Route = $"{ROUTE_PREFIX}/root")] HttpRequest request, FunctionContext context)
	{
		return await ExecuteAsync(async () =>
		{
	...
	public async Task<IActionResult> UpdateRootAsync([HttpTrigger(AuthorizationLevel.Function, "put", Route = $"{ROUTE_PREFIX}/root/{{id:long}}")] HttpRequest request, FunctionContext context, long id)
	{
		return await ExecuteAsync(async () =>
		{
	...
	public async Task<IActionResult> DeleteRootAsync([HttpTrigger(AuthorizationLevel.Function, "delete", Route = $"{ROUTE_PREFIX}/root/{{id:long}}")] HttpRequest request, FunctionContext context, long id)
	{
