...
public static class DictionaryRootSpecification
{
    ...
    //{
    //    Specification<DictionaryRoot> specification = Specification<DictionaryRoot>.All
    //    if (!string.IsNullOrWhiteSpace(criteria.Code))
    //    {
    //        specification &= CodeEquals(criteria.Code);
    //    }
    //    if (!string.IsNullOrWhiteSpace(criteria.Name))
    //    {
    //        specification &= NameContains(criteria.Name);
    //    }
