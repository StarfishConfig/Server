	...
	: BackgroundService
{
	...
	private async Task SeedingAccountDataAsync(CancellationToken cancellationToken = default)
	{
		var username = configuration.GetValue<string>("DataSeeding:Users:0:Username");
		var password = configuration.GetValue<string>("DataSeeding:Users:0:Password");
