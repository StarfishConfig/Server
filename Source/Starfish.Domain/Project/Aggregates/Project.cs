...
/// </summary>
public sealed class Project : Aggregate<long>, IAuditing
{
	/// <summary>
	...
	/// <summary>
	/// Gets or sets the date and time when the <see cref="Project"/> was created.
	/// </summary>
	public DateTime CreateTime { get; set; }

	/// <summary>
	/// Gets or sets the date and time when the <see cref="Project"/> was last updated.
	/// </summary>
	public DateTime UpdateTime { get; set; }

	/// <summary>
	/// Gets or sets the user who created the <see cref="Project"/>.
	/// </summary>
	public string CreatedBy { get; set; }

	/// <summary>
	/// Gets or sets the user who last updated the <see cref="Project"/>.
	/// </summary>
